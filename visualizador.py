...
def dibujar_todo(frame, datos_visualizacion):
    ...
    # ═══════════════════════════════════════════════════════════════════
    # PASO 3: Dibujar ArUco - SISTEMA ANTIGUO ELIMINADO
    # Ahora se usa OverlayManager en /api/overlay/render
    # ═══════════════════════════════════════════════════════════════════
    if show_aruco and datos_visualizacion.get('aruco'):
        print("[visualizador] ⚠️ Sistema antiguo de ArUco eliminado - usar OverlayManager")
